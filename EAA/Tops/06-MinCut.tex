\begin{TOPbreak}{Minimaler Schnitt in}{ungerichteten Graphen}
	\up\up\begin{itemize}
		...
		\item \begin{description}
			\item[modifizierter Algorithmus von Stoer und Wagner (\algo{Minimum Cut Phase (modifizierter Algorithmus von Stoer und Wagner)}{\input{Algos/08-MinCut.tex}}):]\ \\\up
				\begin{itemize}
