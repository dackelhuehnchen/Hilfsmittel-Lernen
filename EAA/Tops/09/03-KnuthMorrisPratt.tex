\subtop{Knuth-Morris-Pratt-Matcher}{-1.085}
\vspace*{-0.5\baselineskip}\begin{itemize}[itemsep=-2pt]
	...
	mit $q=1,\dots,m$ abhängig von $P$ (\algo{Boundary-Function}{\input{Algos/13-Boundary.tex}})
	...
	\item die letzte Zeile des KMP-Algorithmus ($q\leftarrow\pi(m)$, \algo{Knuth-Morris-Pratt-Matcher}{\input{Algos/14-KMP.tex}})\algobreak ist notwendig, damit nicht an Stelle $m+1$ in der nächsten Iteration weitergemacht wird
