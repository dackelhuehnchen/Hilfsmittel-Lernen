...
Hier wird der Schwerpunkt eines Knotens auf $L_2$ berechnet und so die Reihenfolge der Knoten in $X_2$ festgelegt, \algo{Barycenter Heuristic}{\input{Algos/11-barycenter.tex}}
\begin{description}
	\item[Bemerkungen:] \ \\ \vspace*{-\baselineskip}
		\begin{itemize}[itemsep=-1pt]
...
Berechnung er Position auf $L_2$ mittels des Medians (\algo{Median-Heuristik}{\input{Algos/12-median.tex}})
\begin{description}
	\item[Bemerkungen:]\ \\ \vspace*{-\baselineskip}
		\begin{itemize}
